        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                    ...
                    <h6>Pesanan anda sudah sukses dicheck out selanjutnya untuk pembayaran silahkan transfer ke nomor <strong> Dana </strong></h6>
                    <h6><strong>Nomer Dana : 085925732215</strong></h6>
                    <h6><strong>Atas Nama : Suarti</strong></h6>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $no++ }}</td>
                                <td>
                                    <img src="{{ url('assets/cake') }}/{{ $pesanan_detail->barang->gambar }}" width="100" alt="...">
                                </td>
