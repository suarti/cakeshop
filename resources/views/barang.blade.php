        ...
        <div class="col-md-8 mt-2">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Birthday Cake</li>
              </ol>
            </nav>
        </div>
        <div class="col-md-8">
            ...
            <section class="best-product mt-3">
                <h5><strong>Birthday Cake</strong></h5>
                <div class="row mt-3">
                    @foreach($barangs as $bg)
                    <div class="col-md-3 mb-3">
                        <div class="card shadow">
                            <div>
                                <img src="{{ url('assets/cake') }}/{{ $bg->gambar }}" class="img-fluid" max-height="100px">
                                <div class="row mt-2">
                                    <div class="col-md-12">
